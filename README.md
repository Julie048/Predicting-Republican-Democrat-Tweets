...
- **historical-users-filtered.json** : the json file containing information on the users who wrote the tweets of the dataset used. I did not uploaded the rest of the dataset as it was very big, but it is the folder data of the github : https://github.com/alexlitel/congresstweets. Many thanks to alexlitel for creating this dataset !
...
- **Baseline_model.ipynb** : an SVM model which act as a baseline model for the project 
